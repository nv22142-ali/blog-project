...
const Header = () => {
  ...
  return (<section>
    <header className="container mx-auto px-5 flex justify-between py-4 items-center">
      ...
      <div className={'${navIsVisible ? "right-0": "-right-full"} mt-[56px] lg:mt-0 bg-dark-hard lg:bg-transparent z-[49] flex flex-col w-full lg:w-auto justify-center lg:justify-end lg:flex-rox fixed top-0 bottom-0 lg:static gap-x-9 items-center'}>
        <ul className="text-white lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 font-semibold">
